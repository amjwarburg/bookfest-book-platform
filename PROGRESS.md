...
- [x] (01.06.26) Home page integration with dynamic movement (use AOS animate on scroll library or LottieFiles)
...
- [x] (14.05.26) Cancel button on the edit page
...
- [x] (14.05.26) Replace nested callbacks in GET /edit/:id
